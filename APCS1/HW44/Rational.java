...
/*
Team Coolios--Shafali Gupta, Kevin Wang
APCS1 Pd. 8
...
public class Rational implements Comparable {
	...
	public boolean equals(Object other) {
		...
		reduce();
		return compareTo(other) == 0; //compares if two Rationals are equivalent
	}//end equals()
	...
	public int compareTo(Object other) {
		...
		if (other instanceof Rational) {
			return _numerator * ((Rational) other)._denominator - _denominator * ((Rational) other)._numerator;
		} else
			throw new ClassCastException("Not a Rational!");
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(r + " as a floating pt approximation: " + r.floatValue());
		System.out.println(s + " as a floating pt approximation: " + s.floatValue());
		System.out.println(t + " as a floating pt approximation: " + t.floatValue());
